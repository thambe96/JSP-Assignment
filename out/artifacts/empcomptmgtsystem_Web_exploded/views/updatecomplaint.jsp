        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <h4 class="card-title text-center mb-4 text-muted">Update Complaint</h4>

                    <form method="post" action="updateCompController">
                        <div class="form-floating mb-3">
                                <textarea
                                        class="form-control"
                                        id="updateComplaint"
                                        name="updateComplaint"
                                        placeholder="Enter your complaint update..."
                                        required></textarea>
                            <label for="updateComplaint">Update Complaint</label>
